...
if(!isset($_GET['part'])){
?>
  <form action='newcomment.php' method='GET' enctype='multipart/form-data'>
...
elseif($_GET['part']=="sensor_p" && !isset($_GET['id'])){
 	echo "<form action='newcomment.php' method='GET' enctype='multipart/form-data'>";
...
elseif(isset($_GET['id']) || ($_GET['part'] != "sensor_p")){
 	echo "<form action='newcomment_proc.php' method='POST' enctype='multipart/form-data'>";
		if(!isset($_GET['id'])){
			$part = $_GET['part'];
