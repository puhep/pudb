...
class nusoap_client extends nusoap_base  {
	...
	* @access   public
	*/
	function call($operation,$params=array(),$namespace='http://www.physics.purdue.edu',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
	...
	*/
	function getOperationData($operation){
		...
		print_r(array_keys($this->operations));
