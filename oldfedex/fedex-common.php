...
function writeToLog($client){  
	...
	###Wtih nuSOAP
	fwrite($logfile, sprintf("\r%s:- %s",date("D M j G:i:s T Y"), $client->request. "\r\n" . $client->response."\r\n\r\n"));
}
...
function getProperty($var){
	if($var == 'key') Return '0iva1w9JaWKEfQ5F'; 
	if($var == 'password') Return '7R3YlwkG2qmETRg2aU62ZGBpS'; 
	...
	if($var == 'trackingnumber') Return '123456789012';
...
function setEndpoint($var){
	...
	if($var == 'endpoint') Return 'https://wsbeta.fedex.com:443/web-services/track';
}
